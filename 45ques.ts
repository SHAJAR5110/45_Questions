// //  QUESTION 02
let person_Name:string="shajar abbas";
...
const titlecaseName: string = personName.split(" ")
...
// //QUESTION 05
const Famous_Personality:string="Quaid-e-Azam Muhammad Ali Jinnah"
const Quote:string="\"I do not believe in taking the right decision, I take a decision and make it right.\""
console.log(`${Famous_Personality} once said,${Quote}`);

// // QUESTION 06
let personName1:string = "\t Shajar Abbas \n";
...
// QUESTION 16
let guestList2:String[]=["Shajar " ,"Hasnat ","Fahad "];
...
// QUESTION 17
let guestList3:string[]=["Arslan ","Shajar ","Noman ","Hasnat ","Uziar ", "Hassan "];
...
// QUESTION 18
let favorite_places_for_visit: string[]=["Paris ","London ","Tokyo ","Greece ","Maldives "];
...
let totalMemberToInvited:number=0;
let Q19_guestList:String[]=["Shajar","Hasnat","Fahad"];
...
console.log("---------------------------------------");
let Q19_guestList2:String[]=["Shajar " ,"Hasnat ","Fahad "];
...
totalMemberToInvited++;
total_invitations++;
let Q19_middleIndex:number=Math.floor(Q19_guestList2.length/2);
...
console.log("---------------------------------------");
let Q19_guestList3:string[]=["Arslan ","Shajar ","Noman ","Hasnat ","Uziar ", "Hassan "];
...
// QUESTION 20
let provinces:string[]=["Punjab","Kpk","Sindh","Balochistan","Gilgit"];
...
const Punjab:P_province={
    name: "Punjab",
    district:42,
    language:"punjabi"
}
const Sindh:P_province={
    name: "Sindh",
    district:30,
    language:"sindhi"
}
const kpk:P_province={
    name: "Kpk",
    district:38,
    language:"pushtu"
}
const Balochistan:P_province={
    name: "Balochistan",
    district:36,
    language:"Balochi"
}
...
// Question 22
let cars:string[]=["Honda Civic","BMW","Porche"];
console.log(cars[3]);
console.log(cars[1]);
...
let testArray:string[]=["Shajar","Hasnat","Fahad","Uziar","Usama"];
...
let testArray1: string[] = ["Shajar", "Hasnat", "Fahad", "Uziar", "Usama"];
let predictName1: string = "Arslan";
...
let alien_color_fail1: string = 'Red';
...
// Question 30
let user_name:string[]=["Shajar","Hasnat","Fahad","Uzair","Admin"];
...
// Question 34
let favoritePizza: string[]=["Pepperoni","Mashrom","Chicken Fajita"];
...
// Question 35
let differentAnimals:string[]=["Dog","Cat","Rabbit"];
...
// Question 37
function make_shirts(size:any="Large",message:string="I love Typescript"):string{
...
// Question 40
function make_album(artistName:string,artistAlbum:string,albumtrack?:number){
    let Album:{artist:string,album:string,track?:number}={
        artist :artistName,
        album: artistAlbum,
        track: albumtrack
        };
...
let magicianName:string[]=["Shajar","Hasnat","Fahad","Uzair","Usama"];
...
function show_magicians1(magicians:string[]):void{
    ...
    let magicianName1:string[]=["Shajar","Hasnat","Fahad","Uzair","Usama"];
...
function show_magicians2(magicians:string[]):void{
    ...
    let magicianName2:string[]=["Shajar","Hasnat","Fahad","Uzair","Usama"];
    let unchangedMagicians:string[]=[];
...
// Question 44
function orderSandwich(arrayOfItem:string[]):void{
console.log("\n-----------Order Summary-----------\n");
...
let sandwich1:string[]=["Ham", "Cheese", "Lettuce", "Tomato"];
let sandwich2:string[]=["Peanut Butter", "Jelly"];
let sandwich3:string[]=["Cheese", "Lettuce", "Tomato"];
orderSandwich(sandwich1);
orderSandwich(sandwich2);
orderSandwich(sandwich3);

// Question 45
function carInfo(name: string, manufacture: string, model: string, ...extraFeature: any[]): { carName: string, manufacturer: string, carmodel: string } {
    let car: { carName: string, manufacturer: string, carmodel: string } = {
        carName: name,
